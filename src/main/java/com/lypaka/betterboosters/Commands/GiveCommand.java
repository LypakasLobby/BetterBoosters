                                                                    ...
                                                                    Commands.argument("booster", StringArgumentType.word())
                                                                            ...
                                                                            .then(
                                                                                    Commands.argument("quantity", IntegerArgumentType.integer(1))
                                                                                            .then(
                                                                                                    Commands.argument("virtual", StringArgumentType.word())
                                                                                                            .executes(c -> {
                                                                                                                ...
                                                                                                                String virt = StringArgumentType.getString(c, "virtual");
                                                                                                                boolean virtual;
                                                                                                                ...
                                                                                                                if (!virt.equalsIgnoreCase("true") && !virt.equalsIgnoreCase("false")) {

                                                                                                                    c.getSource().sendErrorMessage(FancyText.getFormattedText("&cInvalid entry for virtual! Use \"true\" or \"false\"!"));
                                                                                                                    return 1;

                                                                                                                } else {

                                                                                                                    virtual = Boolean.parseBoolean(virt);
                                                                                                                ...
                                                                                                                /*if (virtual) {
                                                                                                                    ...
                                                                                                                    BoosterStorage storage = PixelBoosters.storageMap.get(player.getUniqueID());
                                                                                                                    storage.addBooster(booster.getBooster(), quantity);
                                                                                                                    storage.saveStorage();

                                                                                                                } else {

                                                                                                                    player.addItemStackToInventory(boosterItem);
                                                                                                                    MessagesHandler.sendGiveMessage(player, booster.getBooster(), quantity);
